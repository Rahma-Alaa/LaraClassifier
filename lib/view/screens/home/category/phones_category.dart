...
class PhonesCategory extends StatefulWidget {
  @override
  _PhonesCategoryState createState() => _PhonesCategoryState();
}

class _PhonesCategoryState extends State<PhonesCategory> {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          SectionTitle(title: 'Phones Category'),
          GridView.builder(
