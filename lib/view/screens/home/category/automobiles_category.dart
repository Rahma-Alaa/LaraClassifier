...
class AutomobilesCategory extends StatefulWidget {
  @override
  _AutomobilesCategoryState createState() => _AutomobilesCategoryState();
}

class _AutomobilesCategoryState extends State<AutomobilesCategory> {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          SectionTitle(title: 'Automobiles Category'),
          GridView.builder(
...
class _SearchBarState extends State<SearchBar> {
  String _selectedCategory = 'Automobiles';
