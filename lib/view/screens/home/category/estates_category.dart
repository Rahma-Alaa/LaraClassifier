...
class EstatesCategory extends StatefulWidget {
  @override
  _EstatesCategoryState createState() => _EstatesCategoryState();
}

class _EstatesCategoryState extends State<EstatesCategory> {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          SectionTitle(title: 'Estates Category'),
          GridView.builder(
...
class _SearchBarState extends State<SearchBar> {
  String _selectedCategory = 'Estates';
